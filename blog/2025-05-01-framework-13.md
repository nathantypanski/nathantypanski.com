...
The AMD Framework 13 laptop is everything I loved about ThinkPad at its best: repairable, upgradeable, with high-quality displays and mainline kernel support (Tainted kernels aren't my thing).
...
Hey, wait: we're not checking PCR 15! Without filesystem validation, attackers can [auto-unlock disks by creating rogue copies of the filesystem](https://oddlama.org/blog/bypassing-disk-encryption-with-tpm2-unlock/). Most of the guides online---and my first pass at this configuration---miss this key detail.
For now, let's just enroll encryption with a PIN.
