...
> called kata.
>
> - [Code Kata](http://codekata.com/kata/kata01-supermarket-pricing/)

### Abstraction

> From a bit to a few hundred megabytes, from a microsecond to a half an hour of
> computing confronts us with completely baffling ratio of 109! The programmer
> is in the unique position that his is the only discipline and profession in
> which such a gigantic ratio, which totally baffles our imagination, has to be
> bridged by a single technology. He has to be able to think in terms of
> conceptual hierarchies that are much deeper than a single mind ever needed to
> face before. Compared to that number of semantic levels, the average
> mathematical theory is almost flat. By evoking the need for deep conceptual
> hierarchies, the automatic computer confronts us with a radically new
> intellectual challenge that has no precedent in our history.
>
> - [EWD 1036](https://www.cs.utexas.edu/~EWD/ewd10xx/EWD1036.PDF)
...
It seems like, for all of our time spent building better technology, all of our efforts at making life organization easy are dominated by vendor lock-in and proprietary data formats. [Org-mode](http://orgmode.org/) is maybe the best thing out there - but it's a complex beast, and only works marginally well on, e.g., Android.
...
- [2015-03-22 Take home test](../files/test-takehome.pdf)
