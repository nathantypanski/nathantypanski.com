...
arch.efi: options root=/dev/mapper/vg-main rw rd.luks.name=1b6944df-369f-474b-97b5-76375d6449cc=cryptroot rootflags=subvol=@ /boot/efi/EFI/Linux/arch-secure.efi
arch-hardened.efi: options root=/dev/mapper/vg-main rw rd.luks.name=1b6944df-369f-474b-97b5-76375d6449cc=cryptroot rootflags=subvol=@ rd.luks.options=1b6944df-369f-474b-97b5-76375d6449cc=tpm2-device=auto lsm=capability,landlock,lockdown,yama,apparmor,bpf
arch-hardened-troubleshoot.efi: options root=/dev/mapper/vg-main rw rd.luks.name=1b6944df-369f-474b-97b5-76375d6449cc=cryptroot rootflags=subvol=@ log_level=7 rd.debug
